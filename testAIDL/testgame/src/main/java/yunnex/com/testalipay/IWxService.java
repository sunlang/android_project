 ...
 * Original file: D:\\as_workspace\\Yunnex4\\testalipay\\src\\main\\aidl\\yunnex\\com\\testalipay\\IWxService.aidl
 */
 ...
 * qq 379366152
 */
public interface IWxService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements IWxService
{
private static final String DESCRIPTOR = "yunnex.com.testalipay.IWxService";
...
/**
 * Cast an IBinder object into an yunnex.com.testalipay.IWxService interface,
 * generating a proxy if needed.
 */
public static IWxService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof IWxService))) {
return ((IWxService)iin);
}
...
private static class Proxy implements IWxService
{
